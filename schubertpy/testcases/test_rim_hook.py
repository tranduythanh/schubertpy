...
class TestPartition(unittest.TestCase):
    ...
    def test_remove_rim_hooks_1(self):
        ...
        self.assertEqual(result[0].partition, [2,1])

    def test_remove_rim_hooks_2(self):
        p = Partition([7,2, 1])
        result = p.remove_rim_hooks(7, (3, 4))
        self.assertEqual(result[0].partition, [1,1,1])
    
    def test_remove_rim_hooks_3(self):
        p = Partition([6,4])
        result = p.remove_rim_hooks(7, (3, 4))
        self.assertEqual(result[0].partition, [3])
    ...
    def test_remove_rim_hooks_8(self):
        ...
        self.assertEqual(result[0].partition, [])

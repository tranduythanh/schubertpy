...
def main():
    ...
    # s.print_partition()
    # print(s.latex())
    # fig, ax = s.plot_partition()
    # fig.savefig('schur.png')

    # lc = LinearCombination("S[2,2,2] + 2* S[3,2,1] + S[3,3] + S[4,1,1] + S[4,2]")
    # print(lc)
    # print(embed_str("ahihi", 5))
    # lc.draw_ascii_partition()


    gr = Grassmannian(3, 7) 
    res = gr.mult('S[2,1]', 'S[3]')
    print(res)
    res.draw_ascii_partition()

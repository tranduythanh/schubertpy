...
% Custom spacing for subsubsection to match subsection
% \titlespacing*{\subsubsection}
% {0pt}% left margin
% {3.5ex plus 1ex minus .2ex}% space before (same as subsection)
% {2.3ex plus .2ex}% space after (same as subsection)

% Alternative method if titlesec conflicts with IEEEtran:
...
\input{02.schubert.theory.tex}

\input{03.rule.classic.tex}

\input{04.quantum.tex}

\input{05.extension.tex}

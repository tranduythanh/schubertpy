...
class TestPair2PartInner(unittest.TestCase):
    ...
    def test_ok(self):
        self.assertEqual(pair2part_inner([[], [3,1]]), 'S[3,1]')
        self.assertEqual(pair2part_inner([[2], [3,1]]), 'S[4,2]')
        self.assertEqual(pair2part_inner([[3], [3,1]]), 'S[4,2,1]')
        self.assertEqual(pair2part_inner([[4], [3,1]]), 'S[4,2,1,1]')
        self.assertEqual(pair2part_inner([[5], [3,1]]), 'S[4,2,1,1,1]')
        self.assertEqual(pair2part_inner([[5], [3,1,0]]), 'S[4,2,1,1,1,0]')
